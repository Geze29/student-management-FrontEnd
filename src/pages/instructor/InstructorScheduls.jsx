        ...
        <div className="pl-48 sm:pl-80 pt-10 pb-36 ">
          <div className="container mx-auto">
            <table className="table-auto border-collapse">
              <thead>
                <tr>
                  <th className="border-2  border-gray-700 px-1 sm:px-6 sm:py-4">
                    Time
                  </th>
                  {days.map((day) => (
                    <th
                      className="border-2  border-gray-700 px-1 sm:px-6 sm:py-4"
                      key={day}>
                      {day}
                    </th>
                  ))}
              ...
              <tbody>
                {times.map((time) => (
                  <tr key={time}>
                    <td className="border-2  border-gray-700 px-1 sm:px-6 sm:py-4">
                      {time}
                    </td>
                    {days.map((day) => {
...
export default InstructorScheduls;
